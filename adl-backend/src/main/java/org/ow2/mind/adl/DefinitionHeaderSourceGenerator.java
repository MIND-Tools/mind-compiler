 ...
 * files using the {@value #DEFINITIONS_HEADER_TEMPLATE_NAME} template.
 */
public class DefinitionHeaderSourceGenerator extends AbstractSourceGenerator
    implements
      DefinitionSourceGenerator {

  protected static final String DEFINITIONS_HEADER_TEMPLATE_NAME = "st.definitions.header.Component";
   ...
   * Public constructor.
   */
  public DefinitionHeaderSourceGenerator() {
    super(DEFINITIONS_HEADER_TEMPLATE_NAME);
  }
