...
/**
 * ADL annotation that can be used to specify CPP compilation flags. This
 * annotation can be attached to :
 * <ul>
 * <li>{@link Source} node to specify C-flags that must be used when compiling
 * the given implementation file.</li>
 * <li>{@link Definition} node to specify C-flags that must be used when
 * compiling every source file related to this definition, include generated
 * files.</li>
 * </ul>
 */
public class CPPFlags implements Annotation {
