 ...
 */
public abstract class AbstractDefinitionReferenceResolver
    implements
  ...
  public DefinitionReferenceResolver clientResolverItf;
  ...
  public void bindFc(final String s, final Object o)
    ...
    if (CLIENT_RESOLVER_ITF_NAME.equals(s)) {
      clientResolverItf = (DefinitionReferenceResolver) o;
    } else {
      throw new NoSuchInterfaceException("No client interface named '" + s
